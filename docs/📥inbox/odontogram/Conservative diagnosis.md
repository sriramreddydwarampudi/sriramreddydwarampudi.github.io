...
(i) amalgam ‘blues’, 
(ii) proximal overhangs, 
(iii) marginal ditching, 
(iv) voids,
(v) fracture lines,
(vi) lines indicating the interface between abutted amalgam restorations placed at separate times,
(vii) improper anatomic contours,
(viii) marginal ridge incompatibility,
(ix) improper proximal contacts, 
(x) improper occlusal contacts, and 
(xi) recurrent caries lesions
